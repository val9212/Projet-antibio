...
if __name__ == "__main__":
    ...
    for i in l_data_2:
        ...
        for key, value in i.items():
            ...
            for y in data:
                ...
                print(i) #les résultats sont par base et dans l'ordre alphabetique des genres.
                ...
                if tp + fp != 0:
                    ...
                    precision = 0
                if precision + sensi != 0:
                    f_mesure = 2*((precision*sensi)/(precision+sensi))
                else :
                    f_mesure = 0
                ...
                metrique["F-mesure"].append(f_mesure)
    ...
    for i in l_metrique_f:
        ...
        l_fmesure = [item for sublist in l_fmesure for item in sublist]
        print(f"sensi {l_sensi}")
        print(f"speci {l_speci}")
        print(f"accu {l_accu}")
        print(f"neg {l_neg}")
        print(f"preci {l_precision}")
        print(f"fmesure {l_fmesure}")
        print("==============")

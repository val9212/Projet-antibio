...
```{r}
data <- read.csv('C:/Users/Valentin/PycharmProjects/Projet-antibio/results/table.csv')
...
```{r}
data <- read.csv("C:/Users/Valentin/PycharmProjects/Projet-antibio/antibiotiquesV2_db.csv")
...
```{r}
data <- read.csv("C:/Users/Valentin/PycharmProjects/Projet-antibio/classV2_db.csv")
data$Argannot <- as.integer(data$Argannot)
data$card <- as.integer(data$card)
data$ncbi <- as.integer(data$ncbi)
data$resfinder <- as.integer(data$resfinder)
